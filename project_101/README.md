...
This project is collaboratively developed with defined roles to ensure quality and efficiency:

*   **Lead Developer**: Core architecture, backend logic, and system integration.
*   **Co-Programmer**: Focuses on specific modules, frontend development, and assisting with bug fixes (refer to `co_programmer_tasks.txt`).
*   **QA Tester**: Responsible for manual testing, documenting bugs, and providing UX/UI recommendations (refer to `tester_task.txt`).
...
**Developed for**: Don Mariano Marcos Memorial State University - San Luis Campus  
