...
import { Eye, EyeOff, Lock, Mail, Loader2, ShieldAlert, FileWarning } from 'lucide-react';
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-blue-200">Fast and efficient emergency response</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-xl bg-white/10 backdrop-blur-sm flex items-center justify-center">
          ...
          <div className="bg-slate-800/80 backdrop-blur-xl border border-slate-700 rounded-2xl shadow-2xl overflow-hidden">
            ...
            <div className="relative px-8 pt-8 pb-6 text-center">
              ...
              <motion.div
                ...
                className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-600 to-indigo-600 mb-4 shadow-lg shadow-blue-600/25"
              >
